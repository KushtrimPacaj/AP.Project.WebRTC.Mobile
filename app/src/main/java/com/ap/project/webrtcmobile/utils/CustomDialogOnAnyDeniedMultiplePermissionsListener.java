 ...
 */
public class CustomDialogOnAnyDeniedMultiplePermissionsListener extends BaseMultiplePermissionsListener {
    ...
    private CustomDialogOnAnyDeniedMultiplePermissionsListener(Context context, String title,
    ...
    public static class Builder {
        ...
        public CustomDialogOnAnyDeniedMultiplePermissionsListener build() {
            ...
            return new CustomDialogOnAnyDeniedMultiplePermissionsListener(context, title, message, buttonText, icon);
        }
    }
}
